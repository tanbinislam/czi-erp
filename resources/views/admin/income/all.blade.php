    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header card_header">
                <div class="row">
                    <div class="col-md-8">
                        <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> All Income Information</h4>
                    </div>
                    ...
                    <div class="col-md-7">
                        @if(Session::has('success'))
                          <div class="alert alert-success alertsuccess" role="alert">
                             <strong>Success! Successfully added Income Information</strong> {{Session::get('success')}}
                          </div>
                        @endif
                        @if(Session::has('softSuccess'))
                          <div class="alert alert-success alertsuccess" role="alert">
                             <strong>Success! Successfully deleted Income Information</strong> {{Session::get('success')}}
                          </div>
                        @endif
                        @if(Session::has('upSuccess'))
                          <div class="alert alert-success alertsuccess" role="alert">
                             <strong>Success! Successfully updated Income Information</strong> {{Session::get('success')}}
                          </div>
                        @endif
                ...
                <table id="alltableinfo" class="table table-bordered table-striped table-hover dt-responsive nowrap custom_table">
                    ...
                    <tbody>
                      ...
                      <tr>
                          ...
                          <td>
                              <a href="{{url('dashboard/income/view/'.$data->income_slug)}}" title="view"><i class="fas fa-plus-square view_icon"></i></a>
                              <a href="{{url('dashboard/income/edit/'.$data->income_slug)}}" title="edit"><i class="fas fa-pen-square edit_icon"></i></a>
                              @if (auth()->user()->hasRole('Super Admin'))
                              <a href="#" id="softDelete" title="delete" data-toggle="modal" data-target="#softDelModal" data-id="{{$data->income_id}}"><i class="fas fa-trash delete_icon"></i></a>
                              @endif
                          </td>
                      </tr>
                      @endforeach
