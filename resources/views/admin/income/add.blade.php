...
<div class="row">
    <div class="col-12">
      <form method="post" action="{{url('dashboard/income/submit')}}" enctype="multipart/form-data">
        @csrf
        <div class="card">
            <div class="card-header card_header">
                <div class="row">
                    <div class="col-md-8">
                        <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> Add Income Information</h4>
                    </div>
              ...
              <div class="form-group row mb-3 {{ $errors->has('in_cat_id') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-5">
                  <select class="form-control" name="in_cat_id" >
                    ...
                    <option class="form_control" value="{{$category->in_cat_id}}">{{$category->in_cat_name}}</option>
                    @endforeach
                  </select>
