      ...
      <form method="post" action="{{url('dashboard/employee/update')}}" enctype="multipart/form-data">
        ...
        <div class="card">
            <div class="card-header card_header">
                <div class="row">
                    <div class="col-md-8">
                        <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> Edit Employee Information</h4>
                    </div>
            ...
            <div class="card-body">
              ...
              <div class="form-group row mb-3 {{ $errors->has('name') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-7">
                  <input type="text" class="form-control form_control" name="name" value="{{$data->employee_name}}">
                  <input type="hidden" name="id" value="{{$data->employee_id}}"/>
                  <input type="hidden" name="slug" value="{{$data->employee_slug}}"/>
                  @if ($errors->has('name'))
              ...
              <div class="form-group row mb-3 {{ $errors->has('father') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-7">
                  <input type="text" class="form-control form_control" name="father" value="{{$data->employee_father}}">
              ...
              <div class="form-group row mb-3 {{ $errors->has('mother') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-7">
                  <input type="text" class="form-control form_control" name="mother" value="{{$data->employee_mother}}">
              ...
              <div class="form-group row mb-3 {{ $errors->has('dob') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-7">
                  <div class="input-group">
                    <input type="text" class="form-control form_control" id="birththday" name="dob" value="{{$data->employee_dob}}">
                    @if ($errors->has('dob'))
                        <span class="invalid-feedback" role="alert">
              ...
              <div class="form-group row mb-3 {{ $errors->has('nid') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-7">
                  <input type="text" class="form-control form_control" name="nid" value="{{$data->employee_nid}}">
                  @if ($errors->has('nid'))
                      <span class="invalid-feedback" role="alert">
              ...
              <div class="form-group row mb-3 {{ $errors->has('phone') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-7">
                  <input type="text" class="form-control form_control" name="phone" value="{{$data->employee_phone}}">
                  @if ($errors->has('phone'))
                      <span class="invalid-feedback" role="alert">
              ...
              <div class="form-group row mb-3 {{ $errors->has('email') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-7">
                  <input type="email" class="form-control form_control" name="email" value="{{$data->employee_email}}">
                  @if ($errors->has('email'))
                      <span class="invalid-feedback" role="alert">
              ...
              <div class="form-group row mb-3 {{ $errors->has('preadd') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-7">
                  <input type="text" class="form-control form_control" name="preadd" value="{{$data->employee_address}}">
              ...
              <div class="form-group row mb-3 {{ $errors->has('paradd') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-7">
                  <input type="text" class="form-control form_control" name="paradd" value="{{$data->employee_address}}">
              ...
              <div class="form-group row mb-3 {{ $errors->has('blood') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-4">
                  ...
                  <select class="form-control" name="blood" >
                    ...
                    <option class="form_control" value="{{$blood->blood_id}}" @if($data->blood_id==$blood->blood_id) selected @endif>{{$blood->blood_name}}</option>
                    @endforeach
                  </select>
                  @if ($errors->has('blood'))
                      <span class="invalid-feedback" role="alert">
              ...
              <div class="form-group row mb-3 {{ $errors->has('desig_id') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-4">
                  ...
                  <select class="form-control" name="desig_id" >
                    ...
                    <option class="form_control" value="{{$designation->designation_id}}" {{ $designation->designation_id == $data->designation_id ? 'selected' : '' }}>{{$designation->designation_name}}</option>
                    @endforeach
                  </select>
              ...
              <div class="form-group row mb-3 {{ $errors->has('employee_maritial') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-4">
                  <select class="form-control" name="employee_maritial" >
                    ...
                    <option class="form_control" value="Unmarried" {{ $data->employee_maritial == 'Unmarried' ? 'selected' : ''  }}>Unmarried</option>
                    <option class="form_control" value="Married" {{ $data->employee_maritial == 'Married' ? 'selected' : ''  }}>Married</option>
                  </select>
                ...
                <div class="col-sm-4">
                  ...
                  <select class="form-control" name="department" >
                    ...
                    @foreach ($departments as $department)
                      <option class="form_control" value="{{$department->department_id}}" {{ $data->department_id == $department->department_id ? 'selected' : ''  }}>{{ $department->department_name }}</option>
                    @endforeach
                    </select>
              ...
              <div class="form-group row mb-3">
                  ...
                  <div class="col-sm-4">
                    ...
                    <img height="100" src="{{asset('uploads/employee/'.$data->employee_photo)}}" alt="Employee">
                    @else
                    <img id="img-upload"/>
                    @endif
                  </div>
