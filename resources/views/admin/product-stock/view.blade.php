    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header card_header">
                <div class="row">
                    <div class="col-md-8">
                        <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> View Material Information</h4>
                    </div>
                          ...
                          <tr>
                            ...
                            <td>
                              @if($data->material_photo!='')
                                <img class="img-thumbnail img200" src="{{asset('uploads/material/'.$data->material_photo)}}"/>
                              @else
