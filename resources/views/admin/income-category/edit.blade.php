...
<div class="row">
    <div class="col-12">
      <form method="post" action="{{url('dashboard/income/category/update')}}" enctype="multipart/form-data">
        @csrf
        <div class="card">
            <div class="card-header card_header">
                <div class="row">
                    <div class="col-md-8">
                        <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> Edit Income-Category Information</h4>
                    </div>
            ...
            <div class="card-body">
              ...
              <div class="form-group row mb-3 {{ $errors->has('name') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-7">
                  <input type="hidden" name="id" value="{{$data->in_cat_id}}">
                  <input type="text" class="form-control form_control" name="name" value="{{$data->in_cat_name}}">
                  @if ($errors->has('name'))
              ...
              <div class="form-group row mb-3">
                ...
                <div class="col-sm-7">
                  <input type="text" class="form-control form_control" name="remarks" value="{{$data->in_cat_remarks}}">
                </div>
              </div>
            </div>
