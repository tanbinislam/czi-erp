...
<div class="row">
    <div class="col-12">
      <form method="post" action="{{url('dashboard/expense/submit')}}" enctype="multipart/form-data">
        @csrf
        <div class="card">
            <div class="card-header card_header">
                <div class="row">
                    <div class="col-md-8">
                        <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> Add Expense Information</h4>
                    </div>
            ...
            <div class="card-body">
              ...
              <div class="form-group row mb-3 {{ $errors->has('exp_cat_id') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-5">
                  ...
                  <select class="form-control" name="exp_cat_id" >
                    ...
                    <option class="form_control" value="{{$category->exp_cat_id}}">{{$category->exp_cat_name}}</option>
                    @endforeach
                  </select>
              ...
              <div class="form-group row mb-3 {{ $errors->has('details') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control form_control" name="details" value="{{old('details')}}">
                ...
                <div class="form-group row mb-3 {{ $errors->has('amount') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control form_control" name="amount" value="{{old('amount')}}">
              ...
              <div class="form-group row mb-3 {{ $errors->has('date') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-5">
                  <div class="input-group">
                    <input type="text" class="form-control form_control" id="birththday" name="date" value="{{old('date')}}">
