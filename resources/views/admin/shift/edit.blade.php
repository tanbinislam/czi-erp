...
<div class="row">
    <div class="col-12">
      <form method="post" action="{{url('dashboard/shift/update')}}" enctype="multipart/form-data">
        @csrf
        <div class="card">
            <div class="card-header card_header">
                <div class="row">
                    <div class="col-md-8">
                        <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> Edit Shift Information</h4>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <input type="time"  class="form-control form_control" name="time" value="{{ $data->time }}">
                                @if ($errors->has('time'))
                                    <span class="invalid-feedback" role="alert">
                          <strong>{{ $errors->first('time') }}</strong>
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="time"  class="form-control form_control" name="to_time" value="{{ $data->to_time }}">
