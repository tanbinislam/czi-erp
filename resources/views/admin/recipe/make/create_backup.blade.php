...
@else
    <div class="row">
        <div class="col-12">
            <form method="post" action="{{url('dashboard/recipe-material-store')}}" enctype="multipart/form-data">
                @csrf
            ...
            <div class="modal-content">
                ...
                <div class="modal-body modal_card">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control form_control_modal" name="quantity" value="{{old('quantity')}}">
                        </div>
                    </div>
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        for (x in data) {
                            ...
                            $.each(data[x]['material_purchases'], function (index, value) {
                                html_material_purchases += `<option value="` + value.mp_chalan + `">` + value.mp_chalan +'('+ value.mp_quantity + ')' + `</option>`;
                            });
                            ...
                            $("#chalanName").on("change",function (e) {
                                ...
                                $.ajax({
                                    ...
                                    success:function (response) {
                                        $("#quantity").val(response['mp_quantity']);
                                       let dataVal = response['mp_quantity'];
                                       $("#quantity").keyup(function() {
                                           ...
                                           if ((dataVal >= inputVal) && (dataVal > 0))  {
                                               ...
                                               $("#quantity").css({"border": "1px solid red", "color": "red"});
                                                 alert("Your stock quantity " + response['mp_quantity']);
                                           }
