    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header card_header">
                <div class="row">
                    <div class="col-md-5">
                        <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> Make Recipes Information </h4>
                    </div>
                    <div class="col-md-7 text-right">

                        <a href="{{url('dashboard/recipe-product')}}"
                           class="btn btn-dark btn-md waves-effect btn-label waves-light card_btn"><i
                                class="fas fa-th label-icon"></i>All Make Recipe Product</a>
            ...
            <div class="card-body">
                ...
                <table id="alltableinfo" class="table table-bordered table-striped table-hover dt-responsive nowrap custom_table">
                    ...
                    <tbody>
                      @foreach($all as $data)
                      <tr>
                          <td><a href="{{url('dashboard/recipe-make-list/'.$data->recepie->id.'/'.$data->date)}}">{{ $data->date ?: '' }}</a></td>
                          <td>{{ $data->recepie->name }}</td>
                          <td>
                             <a href="{{url('dashboard/recipe-make-list/'.$data->recepie->id.'/'.$data->date)}}" title="view"><i class="fas fa-plus-square view_icon"></i></a> 
                          </td>
                      </tr>
                      @endforeach
                    </tbody>
