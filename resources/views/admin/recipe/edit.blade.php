...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <form method="post" action='{{url("dashboard/recipe/$data->id")}}' enctype="multipart/form-data">
                @csrf
                <div class="card">
                    <div class="card-header card_header">
                        <div class="row">
                            <div class="col-md-8">
                                <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> Edit Recipe
                                    Information</h4>
                            </div>
                            <div class="col-md-4 text-right">
                                <a href="{{url('dashboard/recipe')}}"
                                   class="btn btn-dark btn-md waves-effect btn-label waves-light card_btn"><i
                                        class="fas fa-th label-icon"></i>All Recipe</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
