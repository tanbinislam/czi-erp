            ...
            <div class="card-body">
              ...
              <div class="form-group row mb-3 {{ $errors->has('name') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-7">
                  ...
                  <input type="hidden" name="slug" value="{{$data->customer_slug}}">
                  <input type="text" class="form-control form_control" name="name" value="{{$data->customer_name}}">
                  @if ($errors->has('name'))
              ...
              <div class="form-group row mb-3 {{ $errors->has('phone') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-7">
                  <input type="text" class="form-control form_control" name="phone" value="{{$data->customer_phone}}">
                  @if ($errors->has('phone'))
                      <span class="invalid-feedback" role="alert">
              ...
              <div class="form-group row mb-3 {{ $errors->has('email') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-7">
                  <input type="email" class="form-control form_control" name="email" value="{{$data->customer_email}}">
                  @if ($errors->has('email'))
                      <span class="invalid-feedback" role="alert">
              ...
              <div class="form-group row mb-3 {{ $errors->has('company') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-7">
                  <input type="text" class="form-control form_control" name="company" value="{{$data->customer_company}}">
              ...
              <div class="form-group row mb-3 {{ $errors->has('website') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-7">
                  <input type="text" class="form-control form_control" name="website" value="{{$data->customer_website}}">
              ...
              <div class="form-group row mb-3 {{ $errors->has('preadd') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-7">
                  <input type="text" class="form-control form_control" name="preadd" value="{{$data->customer_address}}">
              ...
              <div class="form-group row mb-3">
                  ...
                  <div class="col-sm-4">
                    ...
                    <img id="img-upload"/>
                    @ellse
                      <img class="img-thumbnail img100" src="{{asset('uploads/customer/'.$data->customer_photo)}}"/>
                      @endif
                  </div>
              </div>
            </div>
