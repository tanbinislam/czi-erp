    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header card_header">
                <div class="row">
                    <div class="col-md-8">
                        <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> All Customer Payment  Information</h4>
                    </div>
                    ...
                    <div class="col-md-7">
                        @if(Session::has('success'))
                          <div class="alert alert-success alertsuccess" role="alert">
                             <strong>Success! Successfully Customer payment paid Information</strong> {{Session::get('success')}}
                          </div>
                        @endif
                ...
                <table id="alltableinfo" class="table table-bordered table-striped table-hover dt-responsive nowrap custom_table">
                    ...
                    <tbody>
                      ...
                      <tr>
                          ...
                          <td>
                              <a href="{{url('dashboard/customer/payment/'.$data->customer_slug)}}" title="Get Payment"><i class="fas fa-dollar-sign edit_icon"></i></a>
                          </td>
                      </tr>
                      @endforeach
                    </tbody>
