      ...
      <form method="post" action="{{url('dashboard/customer/submit')}}" enctype="multipart/form-data">
        ...
        <div class="card">
            <div class="card-header card_header">
                <div class="row">
                    <div class="col-md-8">
                        <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> Edit Customer Information</h4>
                    </div>
                    <div class="col-md-4 text-right">
                        <a href="{{url('dashboard/customer')}}" class="btn btn-dark btn-md waves-effect btn-label waves-light card_btn"><i class="fas fa-th label-icon"></i>All Customer</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
              ...
              <div class="form-group row mb-3 {{ $errors->has('name') ? ' has-error' : '' }}">
                <label class="col-sm-3 col-form-label col_form_label">Customer Name<span class="req_star">*</span>:</label>
                <div class="col-sm-7">

                  <input type="text" class="form-control form_control" name="name" value="{{ old('customer_name') }}">
                  @if ($errors->has('name'))
              ...
              <div class="form-group row mb-3 {{ $errors->has('customer_phone') ? ' has-error' : '' }}">
                <label class="col-sm-3 col-form-label col_form_label">Phone Number<span class="req_star">*</span>:</label>
                <div class="col-sm-7">
                  <input type="text" class="form-control form_control" name="phone" value="{{ old("customer_phone") }}">
              ...
              <div class="form-group row mb-3 {{ $errors->has('email') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-7">
                  <input type="email" class="form-control form_control" name="email" value="{{ old("customer_email") }}">
                  @if ($errors->has('email'))
                      <span class="invalid-feedback" role="alert">
              ...
              <div class="form-group row mb-3 {{ $errors->has('company') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-7">
                  <input type="text" class="form-control form_control" name="company" value="{{ old("customer_company") }}">
              ...
              <div class="form-group row mb-3 {{ $errors->has('website') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-7">
                  <input type="text" class="form-control form_control" name="website" value="{{ old("customer_website") }}">
              ...
              <div class="form-group row mb-3 {{ $errors->has('preadd') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-7">
                  <input type="text" class="form-control form_control" name="preadd" value="{{ old("customer_address") }}">
              ...
              <div class="form-group row mb-3 {{ $errors->has('previous_due_amount') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-7">
                  <input type="text" class="form-control form_control" name="previous_due_amount" value="{{ old("previous_due_amount") }}">
