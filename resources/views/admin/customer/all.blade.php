    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header card_header">
                <div class="row">
                    <div class="col-md-8">
                        <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> All Customer Information</h4>
                    </div>
                ...
                <table id="alltableinfo" class="table table-bordered table-striped table-hover dt-responsive nowrap custom_table">
                    ...
                    <tbody>
                      ...
                      <tr>
                          ...
                          <td>
                              <a href="{{url('dashboard/customer/payment/'.$data->customer_slug)}}" title="Recive Payment"><i style="font-size: 19px" class="fas fa-dollar-sign edit_icon"></i></a>
                              <a href="{{url('dashboard/customer/product-deliver/create/'.$data->customer_slug)}}" title="Sell Product"><i style="font-size: 19px" class="fas fa-store"></i></a>
                              <a href="{{url('dashboard/customer/profile/'.$data->customer_slug)}}" title="Profile"><i class="fas fa-plus-square view_icon"></i></a>
