      ...
      <form method="post" action="{{url('dashboard/supplier/submit')}}" enctype="multipart/form-data">
        ...
        <div class="card">
            <div class="card-header card_header">
                <div class="row">
                    <div class="col-md-8">
                        <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> Add Supplier Information</h4>
                    </div>
            ...
            <div class="card-body">
              ...
              <div class="form-group row mb-3 {{ $errors->has('company') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-7">
                  <input type="text" class="form-control form_control" name="company" value="{{old('company')}}">
              ...
              <div class="form-group row mb-3 {{ $errors->has('website') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-7">
                  <input type="text" class="form-control form_control" name="website" value="{{old('website')}}">
