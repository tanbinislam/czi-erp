          ...
          <div class="col-12">
              <div class="card">
                  <div class="card-header card_header">
                      <div class="row">
                          <div class="col-md-8">
                              <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> Cash Balance Summary: <span class="text-danger">{{date('d-M-Y', strtotime($from))}}</span> <span class="tospan">to</span> <span class="text-danger">{{date('d-M-Y', strtotime($to))}}</h4>
                          </div>
                  ...
                  <div class="card-body">
                      ...
                      <table id="inexSearchSummary" class="table table-bordered table-striped table-hover dt-responsive nowrap custom_table">
