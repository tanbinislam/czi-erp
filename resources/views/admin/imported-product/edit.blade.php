...
<div class="row">
    <div class="col-12">
      <form method="post" action="{{url('dashboard/imported-product/update')}}" enctype="multipart/form-data">
        @csrf
        <div class="card">
            <div class="card-header card_header">
                <div class="row">
                    <div class="col-md-8">
                        <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> Edit Imported Product Information</h4>
                    </div>
            ...
            <div class="card-body">
              ...
              <div class="form-group row mb-3">
                ...
                <div class="col-sm-7">
                  <input type="text" class="form-control form_control" name="remarks" value="{{$data->remarks}}">
                </div>
              </div>
              <div class="form-group row mb-3">
                  ...
                  <div class="col-sm-4">
                    ...
                    <img height="100" class="img-thumbnail img150" src="{{asset('uploads/imported-product/'.$data->photo)}}"/>
                    @else
                    <img id="img-upload"/>
                    @endif
                  </div>
