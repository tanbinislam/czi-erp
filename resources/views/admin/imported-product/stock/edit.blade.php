...
<div class="row">
    <div class="col-12">
      <form method="post" action="{{url('dashboard/imported-product/stock-purchase/update')}}" enctype="multipart/form-data">
        @csrf
        <div class="card">
            <div class="card-header card_header">
                <div class="row">
                    <div class="col-md-8">
                        <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> Edit Imported Product Stock Information</h4>
                    </div>
            ...
            <div class="card-body">
              ...
              <div class="form-group row mb-3 {{ $errors->has('imp_product') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-5">
                  <select class="form-control" name="imp_product" >
                    ...
                    <option class="form_control" value="{{$product->id}}" {{ $product->id == $data->imported_product_id ? 'selected' : '' }}>{{$product->name}}</option>
                    @endforeach
                  </select>
                  ...
                  @endif
                  <input type="hidden" name="slug" value="{{ $data->purchase_slug }}">
                </div>
              </div>
              <div class="form-group row mb-3">
                <label class="col-sm-3 col-form-label col_form_label">Purchase Date<span class="req_star"></span>:</label>
                <div class="col-sm-7">
                  <input type="date" class="form-control form_control" name="date" value="{{ $data->purchase_date }}">
                  @if($errors->has('date'))
              ...
              <div class="form-group row mb-3">
                ...
                <div class="col-sm-7">
                  <input type="number" min="0" step="0.01" class="form-control form_control" name="qty" value="{{ $data->purchase_quantity }}">
                  @if($errors->has('qty'))
                      <span class="invalid-feedback" role="alert" style="display: block">
              ...
              <div class="form-group row mb-3">
                ...
                <div class="col-sm-7">
                  <input type="number" min="0" step="0.01" class="form-control form_control" name="price" value="{{ $data->purchase_unit_price }}">
                  @if($errors->has('price'))
                      <span class="invalid-feedback" role="alert" style="display: block">
              ...
              <div class="form-group row mb-3">
                ...
                <div class="col-sm-7">
                  <input type="number" min="0" step="0.01" class="form-control form_control" name="chalan" value="{{ $data->purchase_chalan }}">
              ...
              <div class="form-group row mb-3">
                ...
                <div class="col-sm-7">
                  <input type="number" min="0" step="0.01" class="form-control form_control" name="voucher" value="{{ $data->purchase_voucher }}">
