    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header card_header">
                <div class="row">
                    <div class="col-md-8">
                        <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> View Imported Product Information</h4>
                    </div>
                    ...
                    <div class="col-md-8">
                      <table class="table table-bordered table-striped table-hover dt-responsive nowrap custom_view_table">
                          <tr>
                            ...
                            <td>
                              @if($data->photo!='')
                                <img class="img-thumbnail img200" src="{{asset('uploads/imported-product/'.$data->photo)}}"/>
                              @else
                                <img class="img-thumbnail img200" src="{{asset('uploads/avatar/noimg.jpg')}}"/>
                              @endif
                            </td>
                          </tr>
                          <tr>
