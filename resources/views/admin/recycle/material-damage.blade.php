...
@section('content')
@php
    $all=App\Models\Damage::where('damage_status',0)->orderBy('damage_id','DESC')->get();
@endphp
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header card_header">
                <div class="row">
                    <div class="col-md-8">
                        <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> Material Damage Trash List</h4>
                    </div>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>{{$data->joinMaterial->material_name}}</td>
                          ...
                          <td>
                              <a href="#" id="restore" title="restore" data-toggle="modal" data-target="#restoreModal" data-id="{{$data->damage_id}}"><i class="fas fa-recycle restore_icon"></i></a>
                              <a href="#" id="delete" title="delete" data-toggle="modal" data-target="#deleteModal" data-id="{{$data->damage_id}}"><i class="fas fa-trash delete_icon"></i></a>
                          </td>
                      </tr>
                      @endforeach
                    </tbody>
...
<div id="restoreModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <form method="post" action="{{url('dashboard/material/damage/restore')}}">
      @csrf
...
<div id="deleteModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <form method="post" action="{{url('dashboard/material/damage/delete')}}">
      @csrf
      <div class="modal-content">
        <div class="modal-header modal_header">
            <h5 class="modal-title mt-0" id="myModalLabel"><i class="fab fa-gg-circle"></i> Confirm Message</h5>
